...
// CODE HERE
 const oneLineFunction = (parameter1, parameter2) => console.log(`The first parameter is ${parameter1}. The second parameter is ${parameter2}`)
...
////////// PROBLEM 3 //////////
/*
Write a function called 'greeting' that takes 3 parameters: firstName, lastName, and a callback function. In the function, invoke the callback, passing in a 
...
let sayFullName = (firstName, lastName) => {
    let fullName = firstName +" "+ lastName
    console.log(`Hello, my name is ${fullName}`)
}

// INVOKE 'GREETING FUNCTION' HERE
sayFullName("Spencer", "Kendall")
...
For every iteration, calculate a new total cost (original price plus 20% tax), then push it to the 'totalCost' array. After the loop, invoke the callback function, 
